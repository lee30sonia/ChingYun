              ...
              <Paper className={classes.Paper}>
                ...
                {songs.map(obj=>(
                  ...
                  <Card style={{height:'100%'}}>
                    <Content title={obj.title} info={obj.info} link={obj.link} des={obj.description} lyr={obj.lyrics} />
                  </Card>
                  </Grid>
                ))}
                </Grid>
        ...
        <CardContent>
          ...
          <Grid container>
            <Grid item xs={12} md={12} lg={8} xl={7}>
              ...
              <iframe className={classes.video} src={"https://www.youtube.com/embed/"+this.props.link} frameborder="0"allowfullscreen></iframe>
            </Grid>
            <Hidden lgUp>
